...
import creator from "../assets/img/content.png";
...
function Home() {
	...
	let content_description = `Featured Creators from North America! Creating unique content driven by passion. Xmplfy welcomes wonderful talented creators to their team! Click more to check them out`;
