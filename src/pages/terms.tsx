		...
		<Layout>
			<div className="private_container">
				<div className="private">
					...
					<h4 className="grey">OVERVIEW</h4>
					<p className="grey">
						‍This website is operated by xmplfy. Throughout the
						site, the terms “we”, “us” and “our” refer to xmplfy.
						xmplfy offers this website, including all information,
					...
					<h4 className="grey">
						Section 1 - ACCURACY, COMPLETENESS AND TIMELINESS OF
						INFORMATION
					</h4>
					<p className="grey">
					...
					<p className="grey">
						...
						optional third-party tools.Any use by you of the
					...
					<h4 className="grey">Section 3 - THIRD-PARTY LINKS</h4>
					<p className="grey">
						‍Certain content, products and Services available via
						our Service may include materials from
						third-parties.Third-party links on this site may direct
						you to third-party websites that are not affiliated with
						us. We are not responsible for examining or evaluating
						the content or accuracy and we do not warrant and will
						not have any liability or responsibility for any
						third-party materials or websites, or for any other
						materials, products, or Services of third-parties.We are
						not liable for any harm or damages related to the
						purchase or use of goods, Services, resources, content,
					...
					<h4 className="grey">
						Section 3 - USER COMMENTS, FEEDBACK AND OTHER
						SUBMISSIONS
					</h4>
					<p className="grey">
						...
						discretion to be unlawful, offensive, threatening,
					...
					<h4 className="grey">Section 4 - ERRORS</h4>
					<p className="grey">
					...
					<h4 className="grey">Section 5 - PROHIBITED USES</h4>
					<p className="grey">
					...
					<h4 className="grey">Section 6 - TERMINATION</h4>
					<p className="grey">
						...
						our site.If in our sole judgment you fail, or we suspect
					...
					<h4 className="grey">Section 7 - GOVERNING LAW</h4>
					<p className="grey">
					...
					<h4 className="grey">Section 8 - CONTACT INFORMATION</h4>
					<p className="grey">
						‍Please contact us by e-mail at
						jonathan@builtbykodiak.com or joseph@builtbykodiak.com
					</p>
				</div>
			</div>
		</Layout>
